...
-   k_n = normal repulsion strength (force/distance units or pressure
    units - see discussion below)

-   c_n = normal damping coefficient (force/distance units or pressure
    units - see discussion below)

-   c_t = tangential damping coefficient (force/distance units or
...
*rounded/polyhedron*. It bounds the simulation domain with wall(s). All
...
body/rounded/polyhedron](pair_body_rounded_polyhedron) command.

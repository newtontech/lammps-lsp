...
-   [bop](pair_bop) - BOP potential of Pettifor
...
-   [coul/wolf/cs](pair_cs) - Coulomb via Wolf potential with core/shell
    adjustments
...
-   [multi/lucy](pair_multi_lucy) - DPD potential with density-dependent
    force
...
-   [sph/idealgas](pair_sph_idealgas) -
-   [sph/lj](pair_sph_lj) -

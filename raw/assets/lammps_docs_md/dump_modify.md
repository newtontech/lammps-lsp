...
Note that when using the variable option with the *every/time* keyword,
...
Note that if the argument to the [dump_modify every](dump_modify)
...
The [compute displace/atom](compute_displace_atom) command calculates

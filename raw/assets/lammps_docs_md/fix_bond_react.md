...
-   map_file = name of file specifying corresponding atom-IDs in the
...
The *reset_mol_ids* keyword invokes the [reset_atoms mol](reset_atoms)
...
provided below. The \'rxnsum\' and \'rxnave\' functions operate over the
